...
<form action="<c:url value='/adminController/displayReport'/>" method="post">
    ...
    <input type="hidden" name="reportTitle" value="Customer Emails Report">
    <input type="submit" value="User Email Report" class="left_margin" id="button">
</form>

<form action="parameters.jsp" method="post">
    <input type="hidden" name="reportName" value="downloadDetail">
    <input type="hidden" name="reportTitle" value="Sample Downloads Report">
    <input type="submit" value="Downloads report" class="left_margin" id="button">
</form>
