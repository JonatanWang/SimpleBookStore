...
public class OrderController extends HttpServlet {
    ...
    // Post when customer processes an order
    @Override
    ...
    // Do get to show information of cart, or postal address etc
    @Override
    ...
    // Add a new line item into the cart
    ...
    private String checkUser(HttpServletRequest request,
        ...
        // if the Customer object exists, skip Customer registration page
        String url = "";
        if (user != null) {
    ...
    private String processUser(HttpServletRequest request,
        ...
        // If the customer exists, read it from database
        if (CustomerDB.emailExists(email)) {
            ...
            // If the customer does not exist, insert it to database
            user.setFirstName(firstName);
            user.setLastName(lastName);
            user.setEmail(email);
            user.setPassword(password);
    ...
    // Display the invoice/order information and let customer choose to continue or adjust
    ...
    // Complete order, let customer input credit card information 
    private String completeOrder(HttpServletRequest request,
        ...
        // if a record for the Customer object exists, update it
