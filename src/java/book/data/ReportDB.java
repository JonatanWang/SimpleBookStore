...
// Class to create business report
public class ReportDB {

    // Get customer information in an excel table
    public static Workbook getUserEmail() {

        // create the workbook, its worksheet, and its title row
        Workbook workbook = new HSSFWorkbook();
        Sheet sheet = workbook.createSheet("Customer Email Report");
    ...
    // Get download sample statistics in an excel table
